...
export default function SignUp() {
  ...
  return (
      <div className="flex justify-center gap-10">
        <Form className="flex flex-col gap-1 p-8 rounded-lg bg-yellow-500 text-white border-blue-700" onSubmit={signUp} method="post">
          ...
          <button className='bg-blue-500 rounded-lg p-2' type="submit">Sign Up</button>
        </Form>
      </div>
  )
}